...
function ContactInformation({ data, lang }) {
    ...
    useIntersectionObserver('contact-title', 'fade-in');
    useIntersectionObserver('contact-details', 'fade-in');
    useIntersectionObserver('office-contact', 'fade-in');
    useIntersectionObserver('map-container', 'fade-in');
    useIntersectionObserver('contact-link', 'fade-in');
